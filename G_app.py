...
st.set_page_config(page_title="G 폰트 클러스터링", layout="wide")
st.title("G 폰트 상단/하단 두께 비율 K-Means 클러스터링")

file_path = r"./G_result/G_basic_analysis.txt"
original_image_dir = r"./Seg_RGB"
crop_image_dir = r"./G_result" 
    ...
    with col2:
        ...
        if event and len(event.selection.points) > 0:
            ...
            if "customdata" in selected_point:
                ...
                actual_crop_filename = f"{selected_filename}_G_stroke_basic"
