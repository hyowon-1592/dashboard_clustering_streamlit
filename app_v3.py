...
def render_1d_page(title, df, centroids, x_label, file_path, result_folder, suffix=""):
    ...
    with col1:
        ...
        event = st.plotly_chart(fig, on_select="rerun", selection_mode="points", use_container_width=True, key=f"chart_1d_{result_folder}")
...
def render_2d_page(title, df, centroids, file_path, result_folder, suffix=""):
    ...
    with col1:
        ...
        event = st.plotly_chart(fig, on_select="rerun", selection_mode="points", use_container_width=True, key=f"chart_2d_{result_folder}")
